...
INSERT INTO "notes" VALUES(1414941136501,'u->Kx-8|p(',1414927306205,1417465172,-1,' ipa_italian_vowels ','1414941136501aaOpenCentralUnrounded<b>a</b>lto<div>sar<b>à</b></div>VowelIPA officially has no dedicated letter for this sound between front [a] and back [ɑ], it is normally written [a]. A precise notation may be [ä] (centralized) or [a̠] (retracted).[sound:ipa_it_ph_open_central_unrounded.ogg][sound:ipa_it_ex_alto.ogg][sound:ipa_it_ex_sarà.ogg]','a',3279304394,0,'');
